...
import chickenFarmImg from '../assets/chicken_farm.png';
          ...
          <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100 relative">
            ...
            <ul className="space-y-3">
              <li className="flex items-start text-slate-700">
                <GraduationCap className="w-5 h-5 mr-3 text-primary-600 mt-1" />
                <div>
                  Lulus dengan pilihan gelar:
                  <div className="font-bold text-slate-900 mt-1">• Sarjana Manajemen (S.M.)</div>
                  <div className="font-bold text-slate-900">• S.Tr. Akuntansi Perpajakan</div>
                </div>
              </li>
